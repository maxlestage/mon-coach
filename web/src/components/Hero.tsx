...
const copy = {
  fr: {
    ...
    lede: "Mon Coach part de ton corps, de ton matériel, de tes articulations fragiles et du temps que tu as vraiment. Il en tire un programme complet — séries, exercices, charges, sorties, repas — puis le réécrit chaque semaine à partir de ce que tu as réellement fait.",
    ...
    screenAria: "Aperçu de l'écran du jour dans l'application Mon Coach",
  ...
  en: {
    ...
    lede: "Mon Coach starts from your body, your equipment, your fragile joints and the time you actually have. It builds a complete programme from that — sets, exercises, loads, runs, meals — then rewrites it every week from what you really did.",
    ...
    screenAria: "Preview of the today screen in the Mon Coach app",
    day: "Today · week 2",
    session: "Upper body",
    readiness: "Readiness",
    sessionRow: "Session",
  ...
  es: {
    ...
    titleEm: "no al revés",
    lede: "Mon Coach parte de tu cuerpo, tu material, tus articulaciones frágiles y el tiempo que tienes de verdad. Con eso construye un programa completo —series, ejercicios, cargas, rodajes, comidas— y lo reescribe cada semana a partir de lo que has hecho realmente.",
    ...
    screenAria: "Vista previa de la pantalla del día en la aplicación Mon Coach",
    day: "Hoy · semana 2",
