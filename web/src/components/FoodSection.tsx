...
const copy = {
  fr: {
    ...
    dayLede: "Voici la journée que l'application construit pour l'athlète de l'aperçu — 78 kg, prise de muscle, quatre séances par semaine, quatre repas. Le déjeuner et le dîner arrivent en trois services — une entrée de crudités, le plat, un dessert — servis en quantité fixe pour que les macros de la journée tombent quand même juste. Ce ne sont pas des chiffres écrits à la main pour cette page : ils sortent du moteur, et un test de la chaîne d'intégration échoue si la page et l'application cessent de dire la même chose.",
  ...
  en: {
    ...
    dayLede: "This is the day the app builds for the athlete in the preview — 78 kg, building muscle, four sessions a week, four meals. Lunch and dinner come in three courses — a raw-vegetable starter, the main, a dessert — served in fixed amounts so the day's macros still land on target. These are not numbers written by hand for this page: they come out of the engine, and a continuous-integration test fails if the page and the app stop saying the same thing.",
    dayTotals: "Day total",
    dayTarget: "Target",
  ...
  es: {
    ...
    dayLede: "Este es el día que la aplicación construye para el atleta de la vista previa: 78 kg, ganancia muscular, cuatro sesiones por semana, cuatro comidas. La comida y la cena llegan en tres platos — un entrante de crudités, el plato, un postre — servidos en cantidad fija para que las macros del día sigan cuadrando. No son cifras escritas a mano para esta página: salen del motor, y un test de integración continua falla si la página y la aplicación dejan de decir lo mismo.",
