...
const copy = {
  fr: {
    ...
    isTitle: "Ce que Mon Coach est",
    isBody: "Mon Coach est un programmeur d'entraînement : il construit un programme de musculation, un plan de course et des repères nutritionnels à partir des informations que tu fournis, puis les ajuste d'après tes séances et tes sorties. C'est un outil d'aide à l'entraînement, pas un service médical.",
    isNotTitle: "Ce que Mon Coach n'est pas",
  ...
  en: {
    eyebrow: "Legal",
    title: "Terms of use",
    isTitle: "What Mon Coach is",
    isBody: "Mon Coach is a training programmer: it builds a strength programme, a running plan and nutritional targets from the information you provide, then adjusts them from your sessions and your runs. It is a training aid, not a medical service.",
    isNotTitle: "What Mon Coach is not",
  ...
  es: {
    ...
    isTitle: "Lo que Mon Coach es",
    isBody: "Mon Coach es un programador de entrenamiento: construye un programa de fuerza, un plan de carrera y referencias nutricionales a partir de la información que le das, y luego los ajusta según tus sesiones y tus rodajes. Es una herramienta de ayuda al entrenamiento, no un servicio médico.",
    isNotTitle: "Lo que Mon Coach no es",
