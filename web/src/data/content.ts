...
export const faq: Localized<FaqEntry[]> = {
  fr: [
    ...
    { question: "Je suis en situation de handicap. L'application est-elle utilisable ?", answer: "Une section « Handicap » permet de déclarer sa situation — hémiplégie avec le côté atteint, paraplégie, tétraplégie, amputation, mobilité réduite, déficience visuelle, auditive, handicap mental, fauteuil — et le programme de salle en tient compte. Chaque mouvement du catalogue dit ce qu'il exige du corps : tenir debout, une jambe, les deux, un bras, les deux, une barre à deux mains, descendre au sol. Seuls ceux qui sont exécutables sont proposés, et vingt-sept mouvements existent pour ça et n'apparaissent qu'ici. La moitié tient dans un élastique et un mur, ce qui n'était pas le cas au premier essai : mesuré avec une salle complète, le catalogue paraissait complet, et quelqu'un qui s'entraîne chez lui s'entendait répondre qu'il n'y avait rien pour onze muscles sur quatorze. Les séances se répartissent sur ce qui reste, et les muscles pour lesquels le catalogue n'a rien dans cette configuration sortent du calcul au lieu d'apparaître à zéro : l'écran le dit, plutôt que de laisser chercher. Une déficience visuelle, auditive ou mentale ne retire aucun exercice — rien de tout cela n'empêche un mouvement, et en écarter « par prudence » reviendrait à décider à la place de quelqu'un. Côté sports, une famille « Sports adaptés » de onze entrées vit dans la même liste que les autres, et la montre bascule en vrai mode fauteuil pour compter les poussées au lieu des pas. Une réserve honnête : ceci mesure et programme de l'entraînement, ça n'encadre pas une rééducation. Une douleur, une spasticité ou une fatigue inhabituelle se dit à un kinésithérapeute ou à un médecin, pas à un écran." },
  ...
  en: [
    ...
    { question: "I have a disability. Is the app usable?", answer: "A “Disability” section lets you declare your situation — hemiplegia with the affected side, paraplegia, tetraplegia, amputation, reduced mobility, visual or hearing impairment, intellectual disability, wheelchair — and the gym programme takes it into account. Every movement in the catalogue states what it demands of the body: standing, one leg, both, one arm, both, a bar in both hands, getting to the floor. Only the ones you can perform are offered, and twenty-seven movements exist for this and appear nowhere else. Half of them fit in a band and a wall, which was not the case at the first attempt: measured against a full gym the catalogue looked complete, and someone training at home was told there was nothing for eleven muscles out of fourteen. Sessions spread over what remains, and muscles the catalogue cannot serve in that configuration leave the budget rather than showing up at zero: the screen says so instead of letting you search. A visual, hearing or intellectual disability removes no exercise — none of it prevents a movement, and removing some out of caution would be deciding for you. On the sports side, an eleven-entry “Adaptive sports” family lives in the same list as everything else, and the watch switches to a real wheelchair mode, counting pushes instead of steps. One honest caveat: this measures and programmes training, it does not guide rehabilitation. Pain, spasticity or unusual fatigue belongs with a physiotherapist or a doctor, not with a screen." },
