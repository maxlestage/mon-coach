...
export const faq: Localized<FaqEntry[]> = {
  fr: [
    ...
    { question: "Je débute vraiment. Il y a des vidéos ?", answer: "Non, et c'est volontaire. Une vidéo montre un mouvement réussi ; elle ne dit pas ce que tu es en train de rater, ni ce que tu devrais sentir. Le mode guidé déroule chaque mouvement étape par étape, avec des repères que tu peux vérifier sur toi-même, sans miroir, sans caméra et sans réseau. Les erreurs fréquentes y sont décrites par la sensation qui les trahit, pas par ce qu'un observateur verrait. Et chacun des 154 mouvements porte en plus sa propre fiche, les soixante-deux mouvements adaptés compris — ce sont même ceux pour qui elle compte le plus, puisque personne ne les a jamais vus faire : ce que c'est, les réglages précis de cette machine-là, l'erreur qui lui est propre, la charge et le repos qui lui vont, et ce qui peut le remplacer quand l'appareil est pris." },
    ...
    { question: "Je peux m'entraîner sans emporter mon téléphone ?", answer: "Oui, et courir aussi. L'application Apple Watch reçoit la séance du jour déjà prescrite et permet de tout enregistrer au poignet, couronne comprise. Chaque activité — la séance de salle comme les soixante-dix sports, du trail au rameur — ouvre une vraie session d'entraînement : la montre reste éveillée poignet baissé, mesure ton cardio et ta dépense en continu, estime elle-même la distance d'un tapis ou d'un rameur, et enregistre l'entraînement dans Santé pour fermer tes anneaux. Dehors, son propre GPS trace la sortie, téléphone resté à la maison ; la trace remonte au prochain rapprochement des deux appareils. Un bilan avant d'enregistrer te laisse dire la distance d'un home trainer à la couronne. Sur l'iPhone, une Live Activity affiche la série en cours ou la distance parcourue sur l'écran verrouillé." },
    { question: "Je suis une femme. Le cycle est-il pris en compte ?", answer: "Il se renseigne à l'inscription et se modifie à tout moment dans le profil : le premier jour des dernières règles, et la longueur du cycle en jours. La longueur compte autant que la date, et c'est la partie que beaucoup d'applications oublient — l'ovulation se situe quatorze jours avant la fin du cycle, pas au milieu. En comptant depuis le début, un cycle de trente-deux jours voit son ovulation placée quatre jours trop tôt, tous les mois. Ici elle se compte depuis la fin, ce qui n'est juste que si la longueur est renseignée. La date peut aussi se lire depuis Santé, et se retirer d'un geste : décocher efface, ça ne masque pas. Ce que ça donne : ta journée est située dans ton cycle, et tes bilans de forme sont regroupés par phase. Ce que ça ne donne pas, volontairement : aucune modification de tes charges. Les effets des phases sur la performance sont petits et se contredisent d'une étude à l'autre ; plutôt que d'appliquer un tableau tout fait, l'application attend d'avoir six de tes propres bilans par phase — deux cycles environ — avant de dire si une phase change quelque chose chez toi. Tant qu'elle ne l'a pas mesuré, elle ne dit rien. Comme le reste du profil, ça ne quitte pas le téléphone." }, { question: "Je suis en situation de handicap. L'application est-elle utilisable ?", answer: "Une section « Handicap » permet de déclarer sa situation — hémiplégie avec le côté atteint, paraplégie, tétraplégie, amputation, mobilité réduite, déficience visuelle, auditive, handicap mental, fauteuil — et le programme de salle en tient compte. Chaque mouvement du catalogue dit ce qu'il exige du corps : tenir debout, une jambe, les deux, un bras, les deux, une barre à deux mains, descendre au sol. Seuls ceux qui sont exécutables sont proposés, et soixante-deux mouvements existent pour ça et n'apparaissent qu'ici, du poids du corps seul à la machine. La garantie est vérifiée sur chaque matériel plutôt que sur un seul : ce que ton corps peut encore travailler ne dépend pas de ce que tu possèdes. Les séances se répartissent sur ce qui reste, et les muscles pour lesquels le catalogue n'a rien dans cette configuration sortent du calcul au lieu d'apparaître à zéro : l'écran le dit, plutôt que de laisser chercher. Une déficience visuelle, auditive ou mentale ne retire aucun exercice — rien de tout cela n'empêche un mouvement, et en écarter « par prudence » reviendrait à décider à la place de quelqu'un. Côté sports, une famille « Sports adaptés » de onze entrées vit dans la même liste que les autres, et la montre bascule en vrai mode fauteuil pour compter les poussées au lieu des pas. Une réserve honnête : ceci mesure et programme de l'entraînement, ça n'encadre pas une rééducation. Une douleur, une spasticité ou une fatigue inhabituelle se dit à un kinésithérapeute ou à un médecin, pas à un écran." },
    { question: "À quoi sert la section voiture ?", answer: "À enregistrer un trajet sans qu'il pollue quoi que ce soit. Le mode « Conduite » trace le déplacement comme une sortie et ne le compte comme rien : aucune calorie, aucune charge d'entraînement, aucune séance de la semaine, rien dans le plan de course, et aucune session d'entraînement écrite dans Santé — tes anneaux ne bougent pas. Les trajets ont donc leur propre compte, avec les kilomètres du mois, de l'année et depuis le début. Les sports mécaniques, eux, comptent bel et bien : un pilote de motocross tient l'engin aux bras et aux jambes quarante minutes durant, et ce n'est pas parce qu'il y a un moteur qu'il ne fait rien." },
    { question: "Comment savoir ce que fait chaque écran ?", answer: "Chaque onglet porte un point d'interrogation qui ouvre son mode d'emploi : ce qu'on y fait geste par geste avec ce que chaque geste déclenche, la règle exacte qui tourne derrière — pas une métaphore — et ce que l'écran ne fait pas. Un écran « Ce que ça t'apporte », dans le profil, réunit sept avantages suivis chacun du mécanisme qui le rend vrai, ce qui reste gratuit à vie, et cinq refus écrits noir sur blanc. En changeant d'onglet, une fiche d'une demi-seconde rappelle où tu arrives." },
    { question: "C'est encore une application qui compte les calories ?", answer: "Non. Le coach donne une cible quotidienne, explique d'où elle vient, et construit une journée de repas avec des quantités pesables — mais il n'y a aucun journal alimentaire à remplir. La seule donnée nutritionnelle qu'il te demande est ton poids sur la balance, parce que c'est la seule qui permette de vérifier si la cible est juste. Si tu veux quand même savoir ce que tu manges, une photo de ton assiette suffit : la reconnaissance tourne sur le téléphone et te rend une fourchette de protéines, jamais un chiffre au gramme. Elle regarde l'assiette entière puis chacun de ses quartiers, affiche tout ce qu'elle a cru voir — y compris les mots qu'elle ne sait pas traduire — et retient ceux que tu lui apprends." },
  ...
  en: [
    { question: "Does my data go anywhere?", answer: "No. Everything is computed on the device and stored in a single file on the phone. There is no account, no server, no analytics. The one exception is the map background for your activities, Apple Maps served by iOS — and it can be turned off in the profile, in which case your route is still drawn on the phone. You can export all of your data as JSON, or erase everything, from the Profile screen." },
    ...
    { question: "Can I train without carrying my phone?", answer: "Yes, and run too. The Apple Watch app receives the day's session already prescribed and lets you log everything at the wrist, digital crown included. Every activity — the gym session as well as the seventy sports, from trail running to the rowing machine — opens a real workout session: the watch stays awake with your wrist down, measures your heart rate and energy continuously, estimates the distance of a treadmill or a rower by itself, and saves the workout to Health to close your rings. Outdoors, its own GPS traces the activity, phone left at home; the trace comes back the next time the two devices are near each other. A summary before saving lets you dial in an indoor bike's distance with the crown. On the iPhone, a Live Activity shows the current set or the distance covered on the lock screen." },
    { question: "I am a woman. Is my cycle taken into account?", answer: "You enter it during sign-up and can change it any time in your profile: the first day of your last period, and the cycle length in days. The length matters as much as the date, and it is the part many apps forget — ovulation sits fourteen days before the end of the cycle, not in the middle. Counting from the start, a thirty-two-day cycle has its ovulation placed four days too early, every month. Here it is counted back from the end, which is only right if the length is entered. The date can also be read from Health, and removed in one tap: unticking erases, it does not hide. What it gives you: your day is placed within your cycle, and your readiness checks are grouped by phase. What it deliberately does not give: any change to your loads. The effects of cycle phases on performance are small and contradict each other from one study to the next; rather than applying a ready-made table, the app waits for six of your own checks per phase — about two cycles — before saying whether a phase changes anything for you. Until it has measured that, it says nothing. Like the rest of your profile, none of it leaves the phone." }, { question: "I have a disability. Is the app usable?", answer: "A “Disability” section lets you declare your situation — hemiplegia with the affected side, paraplegia, tetraplegia, amputation, reduced mobility, visual or hearing impairment, intellectual disability, wheelchair — and the gym programme takes it into account. Every movement in the catalogue states what it demands of the body: standing, one leg, both, one arm, both, a bar in both hands, getting to the floor. Only the ones you can perform are offered, and sixty-two movements exist for this and appear nowhere else, from bodyweight alone to machines. The guarantee is verified on every equipment set rather than one: what your body can still train does not depend on what you own. Sessions spread over what remains, and muscles the catalogue cannot serve in that configuration leave the budget rather than showing up at zero: the screen says so instead of letting you search. A visual, hearing or intellectual disability removes no exercise — none of it prevents a movement, and removing some out of caution would be deciding for you. On the sports side, an eleven-entry “Adaptive sports” family lives in the same list as everything else, and the watch switches to a real wheelchair mode, counting pushes instead of steps. One honest caveat: this measures and programmes training, it does not guide rehabilitation. Pain, spasticity or unusual fatigue belongs with a physiotherapist or a doctor, not with a screen." },
    { question: "What is the car section for?", answer: "Recording a trip without it polluting anything. “Driving” traces the journey like an outing and counts it as nothing: no calories, no training load, no session of the week, nothing in the running plan, and no workout written to Health — your rings do not move. Trips therefore get their own tally, with the kilometres of the month, the year and all time. Motorsport, on the other hand, does count: a motocross rider holds the machine with arms and legs for forty minutes, and having an engine does not mean doing nothing." },
    { question: "How do I know what each screen does?", answer: "Every tab carries a question mark that opens its user guide: what you do there step by step with what each step triggers, the exact rule running behind it — not a metaphor — and what the screen does not do. A \"What it brings you\" screen, in the profile, lists seven benefits each followed by the mechanism that makes it true, what stays free for life, and five refusals stated in black and white. When you switch tabs, a half-second card reminds you where you are arriving." },
    { question: "Is this another calorie-counting app?", answer: "No. The coach gives a daily target, explains where it comes from, and builds a day of meals with weighable amounts — but there is no food diary to fill in. The only nutritional figure it asks for is your weight on the scale, because it is the only one that can verify whether the target is right. If you do want to know what you ate, a photo of your plate is enough: recognition runs on the phone and gives you a protein range, never a figure to the gram." },
  ...
  es: [
    ...
    { question: "Empiezo de cero. ¿Hay vídeos?", answer: "No, y es a propósito. Un vídeo muestra un movimiento bien hecho; no te dice qué estás fallando ni qué deberías sentir. El modo guiado desglosa cada movimiento paso a paso, con referencias que puedes comprobar en ti mismo, sin espejo, sin cámara y sin conexión. Los errores frecuentes se describen por la sensación que los delata, no por lo que vería un observador. Y cada uno de los 154 movimientos lleva además su propia ficha, incluidos los sesenta y dos adaptados, para los que más importa porque nadie los ha visto hacer nunca: qué es, los ajustes precisos de esa máquina, el error que le es propio, la carga y el descanso que le convienen, y qué puede sustituirlo cuando el puesto está ocupado." },
    ...
    { question: "¿Puedo entrenar sin llevar el teléfono?", answer: "Sí, y correr también. La aplicación de Apple Watch recibe la sesión del día ya prescrita y permite registrarlo todo en la muñeca, corona incluida. Cada actividad, tanto la sesión de gimnasio como los setenta deportes, del trail al remo indoor, abre una verdadera sesión de entrenamiento: el reloj sigue despierto con la muñeca baja, mide tu pulso y tu gasto de forma continua, estima por sí mismo la distancia de una cinta o un remo, y guarda el entrenamiento en Salud para cerrar tus anillos. Fuera, su propio GPS traza la salida, con el teléfono en casa; la traza sube la próxima vez que los dos dispositivos estén cerca. Un resumen antes de guardar te deja indicar con la corona la distancia de un rodillo. En el iPhone, una Live Activity muestra la serie en curso o la distancia recorrida en la pantalla bloqueada." },
    { question: "Soy mujer. ¿Se tiene en cuenta el ciclo?", answer: "Se indica al registrarse y se modifica cuando quieras en el perfil: el primer día de tu última regla y la duración del ciclo en días. La duración importa tanto como la fecha, y es la parte que muchas aplicaciones olvidan: la ovulación se sitúa catorce días antes del final del ciclo, no en la mitad. Contando desde el principio, un ciclo de treinta y dos días ve su ovulación colocada cuatro días antes de tiempo, todos los meses. Aquí se cuenta desde el final, lo que solo es correcto si la duración está indicada. La fecha también puede leerse desde Salud, y se retira con un gesto: desmarcar borra, no oculta. Lo que aporta: tu día queda situado en tu ciclo y tus chequeos de forma se agrupan por fase. Lo que deliberadamente no aporta: ninguna modificación de tus cargas. Los efectos de las fases sobre el rendimiento son pequeños y se contradicen de un estudio a otro; en lugar de aplicar una tabla hecha, la aplicación espera seis de tus propios chequeos por fase — unos dos ciclos — antes de decir si una fase cambia algo en ti. Mientras no lo haya medido, no dice nada. Como el resto del perfil, nada de esto sale del teléfono." }, { question: "Tengo una discapacidad. ¿Puedo usar la aplicación?", answer: "Una sección «Discapacidad» permite declarar tu situación — hemiplejía con el lado afectado, paraplejía, tetraplejía, amputación, movilidad reducida, discapacidad visual, auditiva o intelectual, silla de ruedas — y el programa de sala lo tiene en cuenta. Cada movimiento del catálogo dice lo que exige del cuerpo: estar de pie, una pierna, ambas, un brazo, ambos, una barra a dos manos, bajar al suelo. Solo se proponen los que puedes ejecutar, y sesenta y dos movimientos existen para eso y no aparecen en ningún otro sitio, desde el peso del cuerpo hasta la máquina. La garantía se verifica con cada material y no con uno solo: lo que tu cuerpo aún puede entrenar no depende de lo que poseas. Las sesiones se reparten sobre lo que queda, y los músculos que el catálogo no sabe servir en esa configuración salen del cálculo en lugar de aparecer a cero: la pantalla lo dice, en vez de dejarte buscar. Una discapacidad visual, auditiva o intelectual no retira ningún ejercicio: nada de eso impide un movimiento, y quitarlos «por prudencia» sería decidir por ti. En cuanto a los deportes, una familia «Deportes adaptados» de once entradas vive en la misma lista que los demás, y el reloj pasa a un modo silla de ruedas real, contando impulsos en vez de pasos. Una reserva honesta: esto mide y programa entrenamiento, no dirige una rehabilitación. Un dolor, una espasticidad o un cansancio inhabitual se le dice a un fisioterapeuta o a un médico, no a una pantalla." },
    { question: "¿Para qué sirve la sección coche?", answer: "Para registrar un trayecto sin que contamine nada. «Conducción» traza el desplazamiento como una salida y no lo cuenta como nada: ni calorías, ni carga de entrenamiento, ni sesión de la semana, nada en el plan de carrera, y ninguna sesión escrita en Salud — tus anillos no se mueven. Los trayectos tienen su propia cuenta, con los kilómetros del mes, del año y desde el principio. Los deportes de motor, en cambio, sí cuentan: un piloto de motocross sostiene la máquina con brazos y piernas durante cuarenta minutos, y tener un motor no significa no hacer nada." },
    { question: "¿Cómo sé qué hace cada pantalla?", answer: "Cada pestaña lleva un signo de interrogación que abre su guía: qué se hace ahí paso a paso con lo que provoca cada gesto, la regla exacta que funciona detrás, no una metáfora, y lo que la pantalla no hace. Una pantalla «Lo que te aporta», en el perfil, reúne siete ventajas seguidas cada una del mecanismo que la hace cierta, lo que sigue siendo gratis de por vida, y cinco negativas dichas sin rodeos. Al cambiar de pestaña, una ficha de medio segundo recuerda adónde llegas." },
    { question: "¿Es otra aplicación para contar calorías?", answer: "No. El entrenador da un objetivo diario, explica de dónde sale y construye un día de comidas con cantidades pesables, pero no hay ningún diario alimentario que rellenar. El único dato nutricional que te pide es tu peso en la báscula, porque es el único que permite comprobar si el objetivo es correcto. Si aun así quieres saber qué has comido, basta una foto del plato: el reconocimiento se ejecuta en el teléfono y te da un rango de proteína, nunca una cifra al gramo." },
