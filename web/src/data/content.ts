...
export const faq: Localized<FaqEntry[]> = {
  fr: [
    ...
    { question: "Je suis en situation de handicap. L'application est-elle utilisable ?", answer: "Une section « Handicap » permet de déclarer sa situation — hémiplégie avec le côté atteint, paraplégie, tétraplégie, amputation, mobilité réduite, déficience visuelle, auditive, handicap mental, fauteuil — et le programme de salle en tient compte. Chaque mouvement du catalogue dit ce qu'il exige du corps : tenir debout, une jambe, les deux, un bras, les deux, une barre à deux mains, descendre au sol. Seuls ceux qui sont exécutables sont proposés, et treize mouvements existent pour ça et n'apparaissent qu'ici — développé machine à un bras, leg curl à une jambe, mollet assis à une jambe, rotation élastique assis. Sans eux, filtrer aurait laissé cinq muscles sans un seul exercice. Les séances se répartissent sur ce qui reste, et les muscles pour lesquels le catalogue n'a rien dans cette configuration sortent du calcul au lieu d'apparaître à zéro : l'écran le dit, plutôt que de laisser chercher. Une déficience visuelle, auditive ou mentale ne retire aucun exercice — rien de tout cela n'empêche un mouvement, et en écarter « par prudence » reviendrait à décider à la place de quelqu'un. Côté sports, une famille « Sports adaptés » de onze entrées vit dans la même liste que les autres, et la montre bascule en vrai mode fauteuil pour compter les poussées au lieu des pas. Une réserve honnête : ceci mesure et programme de l'entraînement, ça n'encadre pas une rééducation. Une douleur, une spasticité ou une fatigue inhabituelle se dit à un kinésithérapeute ou à un médecin, pas à un écran." },
