...
export const faq: Localized<FaqEntry[]> = {
  fr: [
    ...
    { question: "Je suis en situation de handicap. L'application est-elle utilisable ?", answer: "Le catalogue contient une famille « Sports adaptés » : marche adaptée, fauteuil, fauteuil de course, handbike, tricycle adapté, natation adaptée, renforcement assis, mobilité assise, basket fauteuil, tennis fauteuil, boccia. Ils vivent dans la même liste que les autres, pas dans une application à part, et la montre bascule en vrai mode fauteuil pour compter les poussées au lieu des pas. L'hémiplégie n'y figure pas comme un sport — c'est un état du corps, pas une activité — mais ce qu'on pratique avec est là. Une réserve honnête : ceci sert à mesurer ces sports correctement, pas à encadrer une rééducation. Les charges prescrites sont conçues pour un corps valide, et adapter les séances elles-mêmes se fait avec un kinésithérapeute." },
  ...
  en: [
    ...
    { question: "I have a disability. Is the app usable?", answer: "The catalogue has an “Adaptive sports” family: adaptive walking, wheelchair, wheelchair racing, handcycling, adaptive tricycle, adaptive swimming, seated strength, seated mobility, wheelchair basketball, wheelchair tennis, boccia. They live in the same list as everything else, not in a separate app, and the watch switches to a real wheelchair mode, counting pushes instead of steps. Hemiplegia is not listed as a sport — it is a state of the body, not an activity — but what you practise with it is there. One honest caveat: this is for measuring those sports correctly, not for guiding rehabilitation. Prescribed loads are designed for an able body, and adapting the sessions themselves belongs with a physiotherapist." },
  ...
  es: [
    ...
    { question: "Tengo una discapacidad. ¿Puedo usar la aplicación?", answer: "El catálogo tiene una familia «Deportes adaptados»: marcha adaptada, silla de ruedas, silla de carreras, handbike, triciclo adaptado, natación adaptada, fuerza sentado, movilidad sentado, baloncesto en silla, tenis en silla, boccia. Viven en la misma lista que los demás, no en una aplicación aparte, y el reloj pasa a un modo silla de ruedas real, contando impulsos en vez de pasos. La hemiplejía no figura como deporte — es un estado del cuerpo, no una actividad — pero lo que se practica con ella sí está. Una reserva honesta: esto sirve para medir bien esos deportes, no para guiar una rehabilitación. Las cargas prescritas están pensadas para un cuerpo sin lesión, y adaptar las sesiones corresponde a un fisioterapeuta." },
