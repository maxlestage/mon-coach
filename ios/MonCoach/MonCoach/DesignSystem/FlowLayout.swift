...
/// Lays subviews out left to right, wrapping to a new line when the current
/// one is full. SwiftUI still has no built-in wrapping stack, and chips for
/// muscle groups and equipment need one.
